...
def main():
    ...
    # Login to WandB
    wandb.login(key='b4ae4f43b4f7648d60ba1539ca06f42f84971ae2')
    
    ## Initialize WANDB
    wandb.init(
		# set the wandb project where this run will be logged
		project= "Virus_Pretrained_Work",
        entity="pratik24111991",
        tags= "Pretraining",
		name="Check",
        #name=args.classes_name+"_"+current_date+"_"+ args.architecture,
	)
    cfg = wandb.config

    cfg.update(vars(model_args))
    cfg.update(vars(data_args))
    cfg.update(vars(training_args))
